...
use App\Repository\MarginForeignRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: MarginForeignRepository::class)]
#[ORM\Table(name: 'margins_foreign')]
class MarginForeign implements MarginInterface
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
